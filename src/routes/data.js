...
router.post("/favourite/:id", (req, res) => {
  req.user
    .updateFavouriteItem(req.params.id)
    .then((result) => {
      res.send(result);
    })
    .catch((err) => {
...
router.post("/dislike/:id", (req, res) => {
  req.user
    .updateDislikedItem(req.params.id)
    .then((result) => {
      res.send(result);
    })
    .catch((err) => {
